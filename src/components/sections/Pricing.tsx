...
const plans: PlanData[] = [
  {
    ...
    note: "Opțional: Domeniu + Găzduire + suport + security updates = 100 lei/lună\n\nCe primești aici NU e doar 'un site frumos'.\n\nCe primești aici este TOP Local SEO, tehnic impecabil, creat de la zero pentru businessul tău și focusat pe apeluri și programări - pentru a converti vizitatorii în clienți.",
    features: [
