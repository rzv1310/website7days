...
const plans: PlanData[] = [
  {
    ...
    description: "Un site web complet funcțional, cu design premium, cu până la 8 pagini personalizate, care arată perfect pe orice ecran și gata să-ți producă bani în fiecare zi.",
    ...
    <div className="h-full flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 p-8 md:p-10 flex flex-col h-full">
          ...
          {plan.note && (
            <p className={`font-body mb-3 text-center whitespace-pre-line ${variant !== "platinum" ? "italic" : ""}`} style={{ color: "white", fontSize: variant === "platinum" ? "15px" : "14px" }}>
              {plan.note}
            </p>
          )}
    ...
    <section className="section-dark py-20 md:py-28">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto md:items-stretch">
          ...
          <div className="mb-[50px] md:mb-0"><PricingCard plan={plans[1]} variant="platinum" /></div>
