      ...
      <div className="container relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="font-body text-sm uppercase tracking-[0.2em] font-medium" style={{ color: "hsl(36, 50%, 62%)" }}>Procesul</span>
            <h2 className="font-display text-3xl md:text-5xl font-bold text-warm-light-text mt-4">
              3 pași simpli spre <span style={{ color: "hsl(36, 50%, 62%)" }}>site-ul tău</span>
            </h2>
          </div>
        </ScrollReveal>
